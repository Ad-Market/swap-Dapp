export const tokenLists = [
    ...
    {
        asset: "c60_t0xFbC4f3f645C4003a2E4F4e9b51077d2DaA9a9341",
        type: "ERC20",
        ...
        decimals: 18,
        logoURI:
            "https://assets-cdn.trustwallet.com/blockchains/ethereum/assets/0xFbC4f3f645C4003a2E4F4e9b51077d2DaA9a9341/logo.png",
        pairs: [],
    },
    {
        symbol: "WETH",
...
// export const addToTokenList = (symbol, name, address, decimals) => {
//     const doesSymbolExistAlready = tokenLists.find((x) => x.symbol == symbol)
//     const doesAddressExistAlready = tokenLists.find((x) => x.address == address)

//     if (
//         !doesAddressExistAlready &&
//         !doesSymbolExistAlready &&
//         name &&
//         decimals &&
//         symbol &&
//         address
...
const edit = new Promise((resolve, reject) => {
    tokenLists.forEach((token, index) => {
        editedTokenList.push({
            id: `${index}x${token.address}`,
...
export const EditTokenList = async () => {
    await edit
    console.log(editedTokenList)
}
